...
<i class="bi bi-three-dots-vertical"></i>            </button>
            <div class="dropdown-menu dropdown-menu-end py-2">';
                ...
                if (AppHelper::perUser('users.destroy')) {
                    $html .= '<div class="dropdown-divider"></div><a href="#" class="dropdown-item text-danger delete-this-role" data-id="' . $model->id . '" data-url="' . route('users.destroy', ['user' => $model]) . '">Delete</a></div></div>';
                }
                return $html;
            })
            ->addColumn('photo', function ($model) {
                return $model->profile_photo_path ? '<img src="'.asset('storage').'/'.$model->profile_photo_path. '" alt="avatar" style="width:50px">' : '<img src="'.asset('admin-assets/assets/img/avatar.jpg').'" alt="avatar" style="width:50px">';
            })
